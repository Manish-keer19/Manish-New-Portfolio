...
//               <div className="w-80 h-80 rounded-full glass p-1 animate-glow">
//                 <div className="w-full h-full rounded-full bg-gradient-to-br from-primary/20 to-neon-blue/20 flex items-center justify-center">
